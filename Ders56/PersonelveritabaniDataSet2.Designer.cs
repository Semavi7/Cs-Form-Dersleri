...
namespace Ders56.PersonelveritabaniDataSet2TableAdapters {
    ...
    public partial class illerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[iller] WHERE (([id] = @Original_id) AND ([sehir] = @Original_s" +
                "ehir))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[iller] SET [sehir] = @sehir WHERE (([id] = @Original_id) AND ([sehi" +
                "r] = @Original_sehir));\r\nSELECT id, sehir FROM iller WHERE (id = @id)";
        ...
        public virtual int Update(string sehir, int Original_id, string Original_sehir, int id) {
            ...
            if ((Original_sehir == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_sehir));
            }
